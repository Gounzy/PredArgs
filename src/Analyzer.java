...
public class Analyzer {
    ...
    public void analyze() {
        ...
        while (changes) {
            ...
            for (Map.Entry<Predicate, ArrayList<Interaction>> entry : this.predicates.entrySet()) {
                Predicate p = entry.getKey();
                ArrayList<Interaction> predicateProfile = entry.getValue();
    ...
    public void computeArgumentProfiles(Predicate p) {
        List<Interaction> pp = this.predicates.get(p);
